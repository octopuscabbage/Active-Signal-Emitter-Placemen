    ...
    if experiment["result"] != []:
        ...
        #    continue
            ...
            try:
                ...
                row[hue_name] = rename_objective_function(experiment["specification"]["objective_function"]) + " " + str(experiment["specification"]["rollout_strategy"])
...
plt.savefig("rollout_strategy.png")
