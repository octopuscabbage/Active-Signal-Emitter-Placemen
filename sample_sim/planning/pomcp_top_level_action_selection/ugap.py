...
from sample_sim.planning.pomcp.pomcp_utilities import get_uct_c
...
class UGapEb(FixedRolloutAllocator, AllocatorWhichChoosesRootActionMixin, UGap):
    ...
    Fixed budget Ugap
    '''
    def __init__(self, rollouts, epsilon, planner_c, logger_name, action_enum):
        self.budget = rollouts
        self.logger_name = logger_name
        self.K = len(action_enum)
        self.b = planner_c
