...
if __name__ == '__main__':
    ...
    base_specs = {
        ...
        "lighting_trigger": [
            #["logprob_fraction",2], 
            #["logprob_fraction",1.5], 
            #["logprob_fraction",1.25], 
            #["logprob_fraction",1.1], 

            #["logprob_fraction",1.05], 
            #["logprob_fraction",1.01], 
            #["logprob_fraction",1.001], 
            ...
            #["every_n",20],
            #["every_n",10],
            #["wait_until_percent", .7, ["logprob_fraction",20], ], 
            #["every_n",30],
            #["wait_until_percent", .5, ["every_n",30], ], 
            #["wait_until_percent", .7, ["every_n",20], ], 
            #["last"],
        ],
        ...
        ## DATA MODEL
        #"data_model": ["additive_factor_graph", "additive_gaussian_process", "conditional_factor_graph"],
        "data_model": ["conditional_factor_graph"],
        "age_measurements": [False],


        "gp.lengthscale": [3 * 5], #Equal to 3x physical step size
        ...
        "use_t_test": [True],
        "t_test_value": [0.3],
        "objective_function": ["entropy", "weighed_bound_deviation","weighed_deviation", "weighed_desirabilty"],
    ...
    debug_spec = {
        ...
        #"state_space_dimensionality": [[12,12]],

        #"lighting_trigger": [["every_n",10]],
        #"lighting_trigger": ["every"],
        ...
        "rollouts_per_step": [2],
        #"data_model": ["conditional_factor_graph"],
        "objective_function": [["ucb_ambient",1]],

        #"objective_function": ["logprob"],
        #"cem.optimizer": ["Nelder-Mead"],
        ...
        "observation_sampling_strategy": ["mean"],
        "rollout_strategy":["random_weighted"]

    }

    if DEBUG:
        base_specs.update(debug_spec)

    specifications.extend(
            SpecificationGenerator().generate(
            base_specs) )

    # for specification in specifications:
    #     if specification["data_model"] == "conditional_factor_graph":
    #         #specification["fg.lighting_model_uncertainty"] = 1
    #         #specification["fg.distance_sigma_scaling"] = 0.01
    #         specification["fg.measurement_uncertainty"] = 0.01
    ...
    if DEBUG:
        ...
        runner.run(name, specifications, PlanningExperiment(),
                   ...
                   specification_runner=RayMultiprocessingRunner(int(6)),
                   context_type="spawn",
                   use_dashboard=True,
                   force_pickle=True
                   )
