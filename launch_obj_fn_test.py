...
base_specs = {
    ...
    "use_t_test": [True],
    "t_test_value": [0.3],
    "objective_function": ["entropy","global_mi",
                            ["ucb_ambient",0.005], ["ucb_ambient",0.0],
                            ["ucb_ambient",0.01], ["ucb_ambient",0.05],
                            ["ucb_ambient",0.1], ["ucb_ambient",0.5],["ucb_ambient",1],["ucb_ambient",3],["ucb_ambient",10], 
                            ["ucb",0.01],["ucb",0.05],["ucb",0.1], ["ucb",0.5],["ucb",1],["ucb",3],["ucb",10],             
                            ["ei_ambient",1.0],["ei_ambient",10],["ei_ambient",0.1],
                            ["ei_ambient",5.0],["ei_ambient",20],["ei_ambient",0.01]
                            ],
