    ...
    if experiment["result"] != []:
        ...
        #    continue
            ...
            try:
                ...
                row[hue_name] = rename_objective_function(experiment["specification"]["objective_function"])
                ...
                row["Objective Function"] = str(experiment["specification"]["objective_function"])
                row["Error"] = float(experiment["result"]["gt_lighting_rmse"])

                of = experiment["specification"]["objective_function"]
                row["of_sort"] = list(of) if isinstance(of,str) else of
