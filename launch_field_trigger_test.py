...
base_specs = {
    ...
    "ground_truth_sdf_environment": [["rectangles",5]],
    ...
    "lighting_trigger": [
        ...
        ["logprob_fraction",1.2], 
        ["logprob_fraction",1.3], 
        ["logprob_fraction",1.4], 
        ["logprob_fraction",5], 
        ["every_n",50],
        ["every_n",30],
        ["every_n",20],
